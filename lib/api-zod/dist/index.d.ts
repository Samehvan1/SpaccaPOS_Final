...
export declare const BaristaLoginResponse: z.ZodObject<{
    user: z.ZodObject<{
        id: z.ZodNumber;
        name: z.ZodString;
        role: z.ZodEnum<["admin", "barista", "frontdesk", "cashier", "pickup"]>;
    }, "strip", z.ZodTypeAny, {
        id: number;
        name: string;
        role: "admin" | "barista" | "frontdesk" | "cashier" | "pickup";
    }, {
        id: number;
        name: string;
        role: "admin" | "barista" | "frontdesk" | "cashier" | "pickup";
...
export declare const ListOrdersResponseItem: z.ZodObject<{
    ...
    status: z.ZodEnum<["pending", "paid", "in_progress", "ready", "completed", "cancelled"]>;
...
export declare const GetOrderResponse: z.ZodIntersection<z.ZodObject<{
    ...
    items: z.ZodArray<z.ZodObject<{
        ...
        customizations: z.ZodArray<z.ZodObject<{
            ...
            customerSortOrder: z.ZodOptional<z.ZodNullable<z.ZodNumber>>;
        }, "strip", z.ZodTypeAny, {
            id: number;
            slotLabel: string;
            optionLabel: string;
